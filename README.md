1. Công nghệ sử dụng
    ...
    Thư viện cần thiết:
        ...
        os (xử lý tệp và thư mục)
   
2. Tính năng phần mềm

    Chọn thư mục chứa ảnh.
    Tùy chỉnh nội dung đóng dấu (text).
    Chọn vị trí đóng dấu (trái, phải, giữa, góc trên, góc dưới...).
    Điều chỉnh kích thước, màu sắc, độ mờ (opacity) của chữ.
    Xuất ra thư mục mới chứa ảnh đã được đóng dấu.
